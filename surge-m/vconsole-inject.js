 ...
 * 脚本行示例：
 * [Script]
 * vconsole = type=http-response,pattern=^https?://example\.com/,requires-body=true,max-size=5242880,script-path=vconsole-inject.js,engine=webview,argument=cdn=https://unpkg.com/vconsole@3.15.1/dist/vconsole.min.js
 */
